            ...
            >
              <div className="mb-6">
                ...
                <div className="rounded-lg border border-slate-700 bg-slate-900/60 backdrop-blur-sm p-5 shadow-sm mb-6">
                  <p className="text-sm text-slate-400 mb-4">
                    We've automatically detected the columns in your CSV. Please
                    confirm or adjust the mappings below.
                  </p>
                ...
                {previewData.length > 0 && (
                  <div className="mt-6">
                    ...
                    <div className="rounded-lg border border-slate-700 bg-slate-900/60 backdrop-blur-sm p-4 overflow-x-auto">
                      ...
                      <div className="flex justify-between items-center mt-4">
                        ...
                        <span className="text-sm text-slate-400">
                          Page {currentPage} of{" "}
                          {Math.ceil(previewData.length / itemsPerPage)}
                        </span>
                        <button
                          type="button"
                          onClick={() =>
              ...
              <div className="flex justify-between">
                ...
                <button
                  type="button"
                  onClick={handleContinue}
                  className="flex items-center rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-5 py-3 font-medium text-white shadow-lg shadow-purple-500/30 transition-all hover:shadow-purple-500/50 hover:scale-[1.02]"
                >
                  Continue <ChevronRight className="ml-2 h-5 w-5" />
                </button>
              </div>
            ...
            >
              ...
              <div className="flex justify-between">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex items-center justify-center rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-5 py-3 font-medium text-white shadow-lg shadow-purple-500/30 transition-all hover:shadow-purple-500/50 hover:scale-[1.02] disabled:opacity-70"
                >
                  {isLoading ? (
                    <>
                    ...
                    <>
                      Proceed to Edit <ArrowUpRight className="ml-2 h-5 w-5" />
                    </>
                  )}
                </button>
              </div>
